<div x-data="{ open: true, search: '' }">
    <div class="mb-5">
        ...
        <input type="description" id="description" name="description" x-model="search" autocomplete="off"
    ...
    <div x-show = 'open'>
        @foreach ($descriptions as $description)
            <div class="items-center justify-between px-2 mb-2 bg-white rounded-sm cursor-pointer"
